...
{
    public partial class ReporteNotasCredito : DevExpress.XtraReports.UI.XtraReport
    {
        public ReporteNotasCredito()
        {
            InitializeComponent();
        }
        ...
        private void ReporteNotasCredito_DataSourceDemanded(object sender, EventArgs e)
        {
